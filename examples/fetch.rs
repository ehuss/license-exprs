...
fn main1() -> errors::Result<()> {
    let debug = std::env::args().any(|e| e == "-d");
...
")?;
    ...
    download(&mut core, "https://raw.githubusercontent.com/spdx/license-list-data/master/json/exceptions.json", |json| {
